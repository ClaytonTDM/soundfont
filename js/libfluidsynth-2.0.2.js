...
function enlargeMemory() {
    ...
    // We can do one page short of 2GB as theoretical maximum.
    ...
    // So the loop below will not be infinite, and minimum asm.js memory size is 16MB.

    while (TOTAL_MEMORY < HEAP32[DYNAMICTOP_PTR >> 2]) {
        // Keep incrementing the heap size as long as it's less than what is requested.
        if (TOTAL_MEMORY <= 536870912) {
            TOTAL_MEMORY = alignUp(2 * TOTAL_MEMORY, PAGE_MULTIPLE);
            // Simple heuristic: double until 1GB...
        } else {
...
function integrateWasmJS() {
    ...
    Module['asm'] = function(global, env, providedBuffer) {
        ...
        if (!env['table']) {
            ...
            if (TABLE_SIZE === undefined)
                TABLE_SIZE = 1024;
            // works in binaryen interpreter at least
        ...
        if (!env['tableBase']) {
            env['tableBase'] = 0;
            // table starts at 0 by default, in dynamic linking this will change
        }
    ...
    // note our method handler, as we may modify Module['asm'] later
}
...
var TTY = {
    ttys: [],
    init: function() {// https://github.com/kripken/emscripten/pull/1555
        ...
        get_char: function(tty) {
            if (!tty.input.length) {
                ...
                if (ENVIRONMENT_IS_NODE) {
                    ...
                    // Node doesn't offer a direct check, so test by exclusion
...
var MEMFS = {
    ...
    expandFileStorage: function(node, newCapacity) {
        ...
        if (node.contents && node.contents.subarray && newCapacity > node.contents.length) {
            ...
            // We might be writing to a lazy-loaded file which had overridden this property, so force-reset it.
        }
...
;var FS = {
    ...
    createDefaultDevices: function() {
        ...
        if (typeof crypto !== 'undefined') {
            ...
            ;
        } else if (ENVIRONMENT_IS_NODE) {} else {
            // default for ES5 platforms
            random_device = function() {
                abort("random_device");
                /*Math.random() is not safe for random number generation, so this fallback random_device implementation aborts... see kripken/emscripten/pull/7096 */
            }
            ;
        }
...
function _usleep(useconds) {
    ...
    if ((ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) && self['performance'] && self['performance']['now']) {
        ...
        while (self['performance']['now']() - start < msec) {// Do nothing.
        }
    } else {
        var start = Date.now();
...
var _delete_fluid_audio_driver = Module["_delete_fluid_audio_driver"] = function() {
    return Module["asm"]["_delete_fluid_audio_driver"].apply(null, arguments)
}
;
var _delete_fluid_event = Module["_delete_fluid_event"] = function() {
    return Module["asm"]["_delete_fluid_event"].apply(null, arguments)
}
;
var _delete_fluid_file_renderer = Module["_delete_fluid_file_renderer"] = function() {
    return Module["asm"]["_delete_fluid_file_renderer"].apply(null, arguments)
}
;
var _delete_fluid_midi_driver = Module["_delete_fluid_midi_driver"] = function() {
    return Module["asm"]["_delete_fluid_midi_driver"].apply(null, arguments)
}
;
var _delete_fluid_midi_event = Module["_delete_fluid_midi_event"] = function() {
    return Module["asm"]["_delete_fluid_midi_event"].apply(null, arguments)
}
;
var _delete_fluid_midi_router = Module["_delete_fluid_midi_router"] = function() {
    return Module["asm"]["_delete_fluid_midi_router"].apply(null, arguments)
}
;
var _delete_fluid_midi_router_rule = Module["_delete_fluid_midi_router_rule"] = function() {
    return Module["asm"]["_delete_fluid_midi_router_rule"].apply(null, arguments)
}
;
var _delete_fluid_mod = Module["_delete_fluid_mod"] = function() {
    return Module["asm"]["_delete_fluid_mod"].apply(null, arguments)
}
;
var _delete_fluid_player = Module["_delete_fluid_player"] = function() {
    return Module["asm"]["_delete_fluid_player"].apply(null, arguments)
}
;
var _delete_fluid_preset = Module["_delete_fluid_preset"] = function() {
    return Module["asm"]["_delete_fluid_preset"].apply(null, arguments)
}
;
var _delete_fluid_sample = Module["_delete_fluid_sample"] = function() {
    return Module["asm"]["_delete_fluid_sample"].apply(null, arguments)
}
;
var _delete_fluid_sequencer = Module["_delete_fluid_sequencer"] = function() {
    return Module["asm"]["_delete_fluid_sequencer"].apply(null, arguments)
}
;
var _delete_fluid_settings = Module["_delete_fluid_settings"] = function() {
    return Module["asm"]["_delete_fluid_settings"].apply(null, arguments)
}
;
var _delete_fluid_sfloader = Module["_delete_fluid_sfloader"] = function() {
    return Module["asm"]["_delete_fluid_sfloader"].apply(null, arguments)
}
;
var _delete_fluid_sfont = Module["_delete_fluid_sfont"] = function() {
    return Module["asm"]["_delete_fluid_sfont"].apply(null, arguments)
}
;
var _delete_fluid_synth = Module["_delete_fluid_synth"] = function() {
    return Module["asm"]["_delete_fluid_synth"].apply(null, arguments)
}
;
...
var _new_fluid_audio_driver = Module["_new_fluid_audio_driver"] = function() {
    return Module["asm"]["_new_fluid_audio_driver"].apply(null, arguments)
}
;
var _new_fluid_audio_driver2 = Module["_new_fluid_audio_driver2"] = function() {
    return Module["asm"]["_new_fluid_audio_driver2"].apply(null, arguments)
}
;
var _new_fluid_defsfloader = Module["_new_fluid_defsfloader"] = function() {
    return Module["asm"]["_new_fluid_defsfloader"].apply(null, arguments)
}
;
var _new_fluid_event = Module["_new_fluid_event"] = function() {
    return Module["asm"]["_new_fluid_event"].apply(null, arguments)
}
;
var _new_fluid_file_renderer = Module["_new_fluid_file_renderer"] = function() {
    return Module["asm"]["_new_fluid_file_renderer"].apply(null, arguments)
}
;
var _new_fluid_midi_driver = Module["_new_fluid_midi_driver"] = function() {
    return Module["asm"]["_new_fluid_midi_driver"].apply(null, arguments)
}
;
var _new_fluid_midi_event = Module["_new_fluid_midi_event"] = function() {
    return Module["asm"]["_new_fluid_midi_event"].apply(null, arguments)
}
;
var _new_fluid_midi_router = Module["_new_fluid_midi_router"] = function() {
    return Module["asm"]["_new_fluid_midi_router"].apply(null, arguments)
}
;
var _new_fluid_midi_router_rule = Module["_new_fluid_midi_router_rule"] = function() {
    return Module["asm"]["_new_fluid_midi_router_rule"].apply(null, arguments)
}
;
var _new_fluid_mod = Module["_new_fluid_mod"] = function() {
    return Module["asm"]["_new_fluid_mod"].apply(null, arguments)
}
;
var _new_fluid_player = Module["_new_fluid_player"] = function() {
    return Module["asm"]["_new_fluid_player"].apply(null, arguments)
}
;
var _new_fluid_preset = Module["_new_fluid_preset"] = function() {
    return Module["asm"]["_new_fluid_preset"].apply(null, arguments)
}
;
var _new_fluid_sample = Module["_new_fluid_sample"] = function() {
    return Module["asm"]["_new_fluid_sample"].apply(null, arguments)
}
;
var _new_fluid_sequencer = Module["_new_fluid_sequencer"] = function() {
    return Module["asm"]["_new_fluid_sequencer"].apply(null, arguments)
}
;
var _new_fluid_sequencer2 = Module["_new_fluid_sequencer2"] = function() {
    return Module["asm"]["_new_fluid_sequencer2"].apply(null, arguments)
}
;
var _new_fluid_settings = Module["_new_fluid_settings"] = function() {
    return Module["asm"]["_new_fluid_settings"].apply(null, arguments)
}
;
var _new_fluid_sfloader = Module["_new_fluid_sfloader"] = function() {
    return Module["asm"]["_new_fluid_sfloader"].apply(null, arguments)
}
;
var _new_fluid_sfont = Module["_new_fluid_sfont"] = function() {
    return Module["asm"]["_new_fluid_sfont"].apply(null, arguments)
}
;
var _new_fluid_synth = Module["_new_fluid_synth"] = function() {
    return Module["asm"]["_new_fluid_synth"].apply(null, arguments)
}
;
